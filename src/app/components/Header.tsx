      ...
      <nav className="container mx-auto px-6 py-4 max-w-7xl">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-4">
            <Link href="/login" className="px-6 py-2 text-gray-700 hover:text-pink-600 transition-colors">
              Sign In
            </Link>
            <Link href="/signup" className="px-6 py-2 bg-gradient-to-r from-pink-600 to-coral-500 text-white rounded-lg hover:shadow-lg transition-all">
              Get Started
            </Link>
          </div>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden mt-4 pb-4 border-t border-gray-200 pt-4">
            <div className="flex flex-col gap-4">
              ...
              <Link href="/login" className="w-full px-6 py-2 text-gray-700 border border-gray-300 rounded-lg hover:border-pink-600 transition-colors text-center">
                Sign In
              </Link>
              <Link href="/signup" className="w-full px-6 py-2 bg-gradient-to-r from-pink-600 to-coral-500 text-white rounded-lg text-center">
                Get Started
              </Link>
            </div>
          </div>
