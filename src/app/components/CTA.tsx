        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div className="bg-pink-900/30 p-8 rounded-xl border border-pink-500/30 backdrop-blur-sm">
              ...
              <Link href="/signup" className="w-full px-8 py-4 bg-gradient-to-r from-pink-600 to-coral-500 text-white rounded-lg hover:shadow-xl transition-all flex items-center justify-center gap-2 group">
                Find Your Mentor
            ...
            <div className="bg-coral-900/30 p-8 rounded-xl border border-coral-500/30 backdrop-blur-sm">
              ...
              <Link href="/signup" className="w-full px-8 py-4 bg-white border-2 border-white text-pink-600 rounded-lg hover:bg-pink-50 transition-colors flex items-center justify-center gap-2 group">
                Become a Mentor
